...
###########################################################
connPFM: Distance-Dependence Motion-Related Artifact Analysis
###########################################################

The ``connPFM`` package is a Python package for running connPFM quality control analyses.

.. image:: https://img.shields.io/pypi/v/connPFM.svg
   :target: https://pypi.python.org/pypi/connPFM/
   :alt: Latest Version

.. image:: https://img.shields.io/pypi/pyversions/connPFM.svg
   :target: https://pypi.python.org/pypi/connPFM/
...
.. image:: https://readthedocs.org/projects/connPFM/badge/?version=latest
...
``connPFM`` is a Python implementation of the methods described in `Power et al. (2018)`_.
...
connPFM is licensed under GNU Lesser General Public License version 2.1.
